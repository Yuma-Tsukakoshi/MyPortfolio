                ...
                <div>
                  ...
                  >
                    <Text size="lg" className={styles.introText}>
                      慶應義塾大学 理工学研究科
                      開放環境科学専攻の塚越雄真と申します。エンジニアとして、技術だけでなくビジネス視点も重視し、クライアントと連携しながら価値を提供することを目指しています。
                    </Text>
                    <Text size="lg" className={styles.introText}>
                      大学時代はプログラミングコミュニティPOSSEでPM・PdMを経験し、その後はインターンで法人向けSaaSや業務自動化システムの開発に携わり、要件定義から設計、開発まで幅広く経験をしました。技術力だけでなく、顧客の課題を理解し、最適なソリューションを提案する力を磨いています。
                    </Text>
                    <Text size="lg" className={styles.introText}>
                      現在は、チームが最大限のパフォーマンスを発揮できる環境を整えることにやりがいを感じていて、技術とビジネスの両方を活かし価値あるプロダクトを作り続けていきたいと思っています。
                    </Text>
                  </motion.div>
                </div>
