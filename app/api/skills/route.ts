export async function GET() {
  return Response.json({
    ...
    backend: [
      ...
      {
        label: "sklearn",
        image: "https://skillicons.dev/icons?i=sklearn",
        is_acquire: true,
      },
      {
        label: "pythorch",
      ...
      {
        label: "flask",
        image: "https://skillicons.dev/icons?i=flask",
        is_acquire: true,
      },
      {
        label: "django",
      ...
      {
        label: "rails",
        image: "https://skillicons.dev/icons?i=rails",
        is_acquire: false,
      },
      {
        label: "ruby",
        image: "https://skillicons.dev/icons?i=ruby",
        is_acquire: false,
      },
    ],
    database: [
    ...
    tools: [
      ...
      {
        label: "arduino",
        image: "https://skillicons.dev/icons?i=arduino",
        is_acquire: true,
      },
    ],
  });
